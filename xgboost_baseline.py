...
xgb = XGBClassifier(eval_metric='mlogloss', random_state=42, tree_method='gpu_hist', predictor='gpu_predictor')
...
xgb = XGBClassifier(n_estimators=100, eval_metric='mlogloss', random_state=42, tree_method='hist', device='cuda')
print(f"XGBoost will use device: {xgb.get_params().get('device', 'cpu')}")
