...
params = {
	...
	"end_date": "2025-05-26",
	"daily": ["temperature_2m_mean", "temperature_2m_max", "temperature_2m_min", "apparent_temperature_mean", "apparent_temperature_max", "apparent_temperature_min", "precipitation_sum", "rain_sum", "wind_speed_10m_max", "wind_gusts_10m_max", "wind_direction_10m_dominant", "shortwave_radiation_sum", "et0_fao_evapotranspiration", "relative_humidity_2m_mean", "relative_humidity_2m_max", "relative_humidity_2m_min", "pressure_msl_mean", "pressure_msl_max", "pressure_msl_min", "surface_pressure_mean", "surface_pressure_max", "surface_pressure_min", "wind_gusts_10m_mean", "wind_speed_10m_mean", "wind_gusts_10m_min", "wind_speed_10m_min", "soil_moisture_0_to_100cm_mean", "soil_moisture_0_to_7cm_mean", "soil_moisture_28_to_100cm_mean", "soil_moisture_7_to_28cm_mean", "soil_temperature_0_to_100cm_mean", "soil_temperature_0_to_7cm_mean", "soil_temperature_28_to_100cm_mean", "soil_temperature_7_to_28cm_mean", "vapour_pressure_deficit_max", "leaf_wetness_probability_mean", "dew_point_2m_mean", "dew_point_2m_max", "dew_point_2m_min", "et0_fao_evapotranspiration_sum", "cloud_cover_mean", "cloud_cover_max", "cloud_cover_min", "growing_degree_days_base_0_limit_50", "snowfall_water_equivalent_sum", "wet_bulb_temperature_2m_mean", "wet_bulb_temperature_2m_max", "wet_bulb_temperature_2m_min", "winddirection_10m_dominant"]
}
...
daily_wind_gusts_10m_mean = daily.Variables(22).ValuesAsNumpy()
daily_wind_speed_10m_mean = daily.Variables(23).ValuesAsNumpy()
daily_wind_gusts_10m_min = daily.Variables(24).ValuesAsNumpy()
daily_wind_speed_10m_min = daily.Variables(25).ValuesAsNumpy()
daily_soil_moisture_0_to_100cm_mean = daily.Variables(26).ValuesAsNumpy()
daily_soil_moisture_0_to_7cm_mean = daily.Variables(27).ValuesAsNumpy()
daily_soil_moisture_28_to_100cm_mean = daily.Variables(28).ValuesAsNumpy()
daily_soil_moisture_7_to_28cm_mean = daily.Variables(29).ValuesAsNumpy()
daily_soil_temperature_0_to_100cm_mean = daily.Variables(30).ValuesAsNumpy()
daily_soil_temperature_0_to_7cm_mean = daily.Variables(31).ValuesAsNumpy()
daily_soil_temperature_28_to_100cm_mean = daily.Variables(32).ValuesAsNumpy()
daily_soil_temperature_7_to_28cm_mean = daily.Variables(33).ValuesAsNumpy()
daily_vapour_pressure_deficit_max = daily.Variables(34).ValuesAsNumpy()
daily_leaf_wetness_probability_mean = daily.Variables(35).ValuesAsNumpy()
daily_dew_point_2m_mean = daily.Variables(36).ValuesAsNumpy()
daily_dew_point_2m_max = daily.Variables(37).ValuesAsNumpy()
daily_dew_point_2m_min = daily.Variables(38).ValuesAsNumpy()
...
daily_growing_degree_days_base_0_limit_50 = daily.Variables(43).ValuesAsNumpy()
daily_snowfall_water_equivalent_sum = daily.Variables(44).ValuesAsNumpy()
daily_wet_bulb_temperature_2m_mean = daily.Variables(45).ValuesAsNumpy()
daily_wet_bulb_temperature_2m_max = daily.Variables(46).ValuesAsNumpy()
daily_wet_bulb_temperature_2m_min = daily.Variables(47).ValuesAsNumpy()
daily_winddirection_10m_dominant = daily.Variables(48).ValuesAsNumpy()
...
daily_dataframe.to_csv('results.csv', index=False)